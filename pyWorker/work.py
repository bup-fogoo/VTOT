...
def fileTrans(akId, akSecret, appKey, fileLink, outFIlePath):
    # 地域ID，固定值。
...
if __name__ == '__main__':
    accessKeyId = "LTAI5tBsLQKQSp7x5fVPeK31"
    accessKeySecret = "NsQ1oRyngYtf0CeNTex91N1Nw6g3N4"
    appKey = "myXjvilkzWXzvKUY"
    fileLink = sys.argv[1]  # 音频文件链接
    outFIlePath = sys.argv[2]  # 保存位置
    # 执行录音文件识别
    fileTrans(accessKeyId, accessKeySecret, appKey, fileLink, outFIlePath)
    # python3 ./work.py https://gw.alipayobjects.com/os/bmw-prod/0574ee2e-f494-45a5-820f-63aee583045a.wav ./a.html
